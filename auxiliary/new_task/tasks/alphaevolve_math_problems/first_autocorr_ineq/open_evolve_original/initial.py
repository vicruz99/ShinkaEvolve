...
if __name__ == "__main__":
    ...
    try:
        f_values, final_c1, final_loss_val, num_intervals = run()
        print(f"Optimized f values (sample): {f_values[:10]} ...")
        print(f"Final C1 found: {final_c1:.8f}")
        print(f"Final loss value: {final_loss_val:.8f}")

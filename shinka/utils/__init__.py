...
_EXPORTS = {
    ...
    "get_path_to_best_node": (".load_df", "get_path_to_best_node"),
    "store_best_path": (".load_df", "store_best_path"),
    "load_prompts_to_df": (".load_df", "load_prompts_to_df"),  # Incoming addition

    # general.py
    "parse_time_to_seconds": (".general", "parse_time_to_seconds"),
    "load_results": (".general", "load_results"),
    "load_configs_from_yaml": (".general", "load_configs_from_yaml"),  # Incoming addition
    ...
    # languages.py
    "get_language_extension": (".languages", "get_language_extension"),  # Incoming addition
